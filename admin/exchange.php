                        ...
                        <table class="table table-sm table-bordered mt-3 n-table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Hàng đã chọn</th>
                                    <th scope="col">Sản phẩm đã trao đổi</th>
                            ...
                            <tbody>
                                ...
                                foreach ($allTS as $ts) {
                                    ...
                                    $prodA = getProductByID($ts['productA'],$conn);
                                    $prodB = getProductByID($ts['productB'],$conn);
                                ?>
                                    <tr>
                                        <th scope="row">
                                            <?php echo $i;
                                        ...
                                        <td scope="row">
                                            <a href="/product/detail.php?id=<?=$ts['productB']?>">
                                                <?= $prodB['prName'] ?>
                                            </a>
                                        </td>
