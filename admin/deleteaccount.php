...
?>
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="row">
                <div class="">
                    <form class="card" method="post" action="action/deletekh.php">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" placeholder="" value="<?=$cus['lname']?>" disabled>
                                        <label class="form-label">Họ <span style="color: red;">*</span></label>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" placeholder="" value="<?=$cus['byear']?>" disabled>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" placeholder="" value="<?=$cus['password']?>" disabled>
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-primary" style="background-color: red;">Xóa</a>
                            </div>
                            <input name="deleteUser" value="<?=$cus['username']?>" style="visibility: hidden;">
                        </div>
                    </form>
                </div>
            </div>
